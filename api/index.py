...
def generate_gfx_font(font_path, font_size, charset):
    ...
    gfx_output.write("const GFXglyph RajdhaniGlyphs[] PROGMEM = {\n")
    ...
    gfx_output.write("const GFXfont RajdhaniFont PROGMEM = {\n")
    gfx_output.write("  (uint8_t  *)RajdhaniBitmaps,\n")
    gfx_output.write("  (GFXglyph *)RajdhaniGlyphs,\n")
    gfx_output.write("  0x20, 0x7E, "+str(font_size)+"\n")
    gfx_output.write("};\n")
...
def generate_gfx_route():
    ...
    with tempfile.NamedTemporaryFile(delete=False, suffix='.ttf') as temp_font:
        ...
        try:
            ...
            gfx_content = generate_gfx_font(temp_font.name, 120, charset)
